...
from utils.chart_utils import (
    bar_chart_top_songs_spotify,
    pie_bar_chart_top_artist_theweeknd,
)
from utils.spark_utils import (
    trans_df_to_chart_the_weeknd_songs,
    trans_df_to_chart_top_5_data,
)
...
def main():
    ...
    # Making charts
    # --------------------------------------------------------------------------------
    # chart_top_songs_df = trans_df_to_chart_top_5_data(df_parquet_from_hdfs_spark)

    # bar_chart_top_songs_spotify(chart_top_songs_df)

    chart_theweeknd_df = trans_df_to_chart_the_weeknd_songs(
        df=df_parquet_from_hdfs_spark
    )

    # pie_bar_chart_top_artist_theweeknd(params=chart_theweeknd_df)
